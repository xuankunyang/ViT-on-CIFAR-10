...
from models.modeling_sd import VisionTransformer, CONFIGS
...
#是否使用数据增广训练记得注释掉
from left.data_utils import get_loader
...
def main():
    ...
    parser.add_argument("--model_type", choices=["ViT-Ours_SD", "ViT-Ours_Res", "ViT-Ours_new","ViT-Ours", "ViT-B_16", "ViT-B_32", "ViT-L_16",
